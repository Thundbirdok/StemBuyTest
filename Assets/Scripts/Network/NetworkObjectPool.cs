namespace Network
{
    ...
    public class NetworkObjectPool : NetworkBehaviour
    {
        ...
        public static bool IsPrefabsRegistered; 
        ...
        private readonly Dictionary<GameObject, ObjectPool<NetworkObject>> _pooledObjects = new Dictionary<GameObject, ObjectPool<NetworkObject>>();
        ...
        /// </summary>
        void RegisterPrefabInternal(GameObject prefab, int prewarmCount, Transform container)
        {
            NetworkObject CreateFunc()
            {
                return Instantiate(prefab, container).GetComponent<NetworkObject>();
            }
